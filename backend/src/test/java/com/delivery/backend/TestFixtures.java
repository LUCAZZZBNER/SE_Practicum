...
public final class TestFixtures {
  ...
  public static MerchantService.MerchantView merchant(long id) {
    return new MerchantService.MerchantView(
        id, "merchant", "Store", "13900000000", "ACTIVE", TIME, TIME);
  }

  public static MerchantService.AuthSession merchantSession(long id) {
    return new MerchantService.AuthSession(
        "token", "Bearer", 7200, merchant(id), List.of("MERCHANT"));
  }
  ...
  public static ItemService.ProductView product(long id) {
    return new ItemService.ProductView(
        id, 10, 21, "Rice", null, new BigDecimal("12.50"), 5, "ON_SALE", 3, TIME, TIME);
  }
  ...
  public static ShoppingService.CartItemView cartItem(long id) {
    ShoppingService.CartProductView product =
        new ShoppingService.CartProductView(
            30, 10, "Rice", new BigDecimal("12.50"), 5, "ON_SALE", 3);
    return new ShoppingService.CartItemView(
        id, product, 1, new BigDecimal("12.50"), true, null, TIME, TIME);
  }
  ...
  public static OrderService.OrderView order(long id) {
    OrderService.OrderLineView line =
        new OrderService.OrderLineView(
            30, "Rice", new BigDecimal("12.50"), 1, new BigDecimal("12.50"));
    return new OrderService.OrderView(
        id,
        "ORDER-40",
        7,
        10,
  ...
  public static PageResult<OrderService.OrderSummaryView> orderPage() {
    OrderService.OrderSummaryView summary =
        new OrderService.OrderSummaryView(
            40, "ORDER-40", 10, "Shop", new BigDecimal("12.50"), "PENDING_PAYMENT", TIME);
