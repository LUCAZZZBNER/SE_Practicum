package com.delivery.backend.item.image;
...
import com.delivery.backend.item.image.controller.ImageController;
import com.delivery.backend.item.image.service.ImageService;
