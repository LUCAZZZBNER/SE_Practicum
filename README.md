...
需求基线见 [软件需求规格说明书](docs/software-requirements-specification.md)，HTTP 契约见 [后端 API 设计](docs/api/backend-api-design.md)，最终数据库结构见 [数据库设计说明书](数据库设计说明书.md)，测试证据见 [测试执行日志](docs/test/test-log.md)。
