package com.delivery.order.user.service.impl;

import com.delivery.order.common.ApiError;
import com.delivery.order.common.BusinessException;
import com.delivery.order.security.JwtTokenService;
import com.delivery.order.security.Role;
import com.delivery.order.user.dao.UserDao;
import com.delivery.order.user.entity.UserEntity;
...
public class UserServiceImpl implements UserService {
  ...
  public UserServiceImpl(UserDao userDao, JwtTokenService jwtTokenService, PasswordEncoder passwordEncoder) {
  ...
  public UserView updateCurrent(long userId, UpdateRequest request) {
    ...
    userDao.updateProfile(
        userId, request.isNicknameSpecified(), nickname, request.isPhoneSpecified(), phone);
    return toView(requireById(userId));
  }
