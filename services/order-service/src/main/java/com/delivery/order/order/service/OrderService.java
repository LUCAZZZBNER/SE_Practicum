package com.delivery.order.order.service;
...
public interface OrderService {
  ...
  record CreateRequest(
      @NotEmpty List<@NotNull @Valid ItemRequest> items, @Positive Long addressId, String remark) {
  ...
  record ListQuery(
      String status, Integer page, Integer pageSize, String sortBy, String sortOrder) {}

  record MerchantListQuery(
      Long shopId,
      String status,
      Integer page,
      Integer pageSize,
  ...
  record OrderView(
      ...
      String cancelReason,
      Instant completedAt,
      Map<String, String> userAddressSnapshot,
      Map<String, String> shopAddressSnapshot) {
    public OrderView(
        long id,
        String orderNumber,
        long userId,
  ...
  record RefundView(
      long orderId, String refundNumber, BigDecimal amount, String status, Long paymentId) {
