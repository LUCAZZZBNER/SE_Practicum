package com.delivery.order.merchant.service.impl;

import com.delivery.order.common.ApiError;
import com.delivery.order.common.BusinessException;
import com.delivery.order.merchant.dao.MerchantDao;
import com.delivery.order.merchant.entity.MerchantEntity;
...
public class MerchantServiceImpl implements MerchantService {
  ...
  public MerchantView updateCurrent(long merchantId, UpdateRequest request) {
    ...
    merchantDao.updateProfile(
        merchantId, request.isNameSpecified(), name, request.isPhoneSpecified(), phone);
    return toView(requireById(merchantId));
  }
