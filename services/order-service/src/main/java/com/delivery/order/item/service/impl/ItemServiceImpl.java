...
import com.delivery.order.item.image.dao.ImageDao;
...
public class ItemServiceImpl implements ItemService {
  ...
  public void setCatalogStockClient(CatalogStockClient catalogStockClient) {
  ...
  public ProductView createProduct(long merchantId, CreateProductRequest request) {
    ...
    if (skuDao != null)
      for (SkuService.CreateRequest requestSku : skus) {
        var sku = new com.delivery.order.item.entity.SkuEntity();
  ...
  public List<ProductSnapshot> reserveForOrder(List<ReservationRequest> requests) {
    if (catalogStockClient == null || !catalogStockClient.enabled()) {
      throw new BusinessException(ApiError.INTERNAL_ERROR);
    }
    return catalogStockClient.reserve(requests);
  }
  ...
  public void restoreStock(List<StockRestore> restorations) {
    ...
    catalogStockClient.restore(restorations);
  }
