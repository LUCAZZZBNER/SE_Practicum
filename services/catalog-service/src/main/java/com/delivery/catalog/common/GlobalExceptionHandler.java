...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Object>> unauthenticated(
      ServletRequestBindingException exception) {
    return error(ApiError.UNAUTHENTICATED, null);
  }

  @ExceptionHandler(MethodArgumentNotValidException.class)
  public ResponseEntity<ApiResponse<Object>> invalidBody(
  ...
  public ResponseEntity<ApiResponse<Object>> unexpectedFailure(Exception exception) {
    LOGGER.error("Unhandled backend exception type: {}", exception.getClass().getName(), exception);
