package com.delivery.catalog.merchant.shop.service;
...
public interface RestaurantService {
  ...
  record AddressRequest(
      ...
      @Pattern(regexp = "1[0-9]{10}|0[0-9]{10,11}") String phone) {}
  ...
  record ShopView(
    ...
    public ShopView(
        ...
        Instant createdAt,
        Instant updatedAt) {
      this(id, merchantId, name, description, status, null, null, null, createdAt, updatedAt);
    }
  }
