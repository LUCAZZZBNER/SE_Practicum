...
import com.delivery.catalog.common.PatchRequest;
...
public interface ItemService {
  ...
  void confirmReservations(List<String> reservationIds);
  ...
  record CreateProductRequest(
    ...
    public CreateProductRequest(
      ...
      this(
          ...
          stock,
          null,
          List.of(new SkuService.CreateRequest("默认规格", price, stock)));
    }
  ...
  record ProductQuery(
      ...
      String sortBy,
      String sortOrder,
      Boolean includeOffSale,
      Long merchantId) {}

  record CategoryView(
      long id, long shopId, String name, int sortOrder, Instant createdAt, Instant updatedAt) {}
  ...
  record ImageView(long id, String url, String contentType, long size, Instant createdAt) {
    public ImageView(long id, String url) {
      this(id, url, null, 0, null);
    }
  }

  record ReservationRequest(long productId, long expectedVersion, int quantity, long skuId, String reservationId) {
    public ReservationRequest(long productId, long expectedVersion, int quantity, long skuId) {
      this(productId, expectedVersion, quantity, skuId, null);
    }
    public ReservationRequest(long productId, long expectedVersion, int quantity) {
      this(productId, expectedVersion, quantity, 0, null);
    }
  }
  ...
  record StockRestore(long productId, int quantity, long skuId, String reservationId) {
    public StockRestore(long productId, int quantity, long skuId) {
      this(productId, quantity, skuId, null);
    }
    public StockRestore(long productId, int quantity) {
      this(productId, quantity, 0, null);
    }
  }
}
