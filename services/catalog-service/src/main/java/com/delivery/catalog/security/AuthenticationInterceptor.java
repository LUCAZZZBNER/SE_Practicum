...
public class AuthenticationInterceptor implements HandlerInterceptor {
  ...
  private static PublicEndpoint findPublicEndpoint(HandlerMethod method) {
    PublicEndpoint annotation =
        AnnotatedElementUtils.findMergedAnnotation(method.getMethod(), PublicEndpoint.class);
  ...
  private static RequireRole findRequiredRole(HandlerMethod method) {
    RequireRole annotation =
        AnnotatedElementUtils.findMergedAnnotation(method.getMethod(), RequireRole.class);
    return annotation != null
        ? annotation
