package com.delivery.cart.item.service.impl;
...
import com.delivery.cart.item.entity.CategoryEntity;
import com.delivery.cart.item.entity.ProductEntity;
import com.delivery.cart.item.image.dao.ImageDao;
import com.delivery.cart.item.service.ItemService;
import com.delivery.cart.item.service.SkuService;
  ...
  public ProductView createProduct(long merchantId, CreateProductRequest request) {
    ...
    if (skuDao != null)
      for (SkuService.CreateRequest requestSku : skus) {
        var sku = new com.delivery.cart.item.entity.SkuEntity();
