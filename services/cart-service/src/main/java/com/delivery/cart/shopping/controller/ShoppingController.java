...
import com.delivery.cart.common.ApiResponse;
import com.delivery.cart.common.DeleteResult;
import com.delivery.cart.security.CurrentPrincipal;
import com.delivery.cart.security.RequireRole;
...
public class ShoppingController {
  ...
  public ApiResponse<ShoppingService.CartItemView> changeQuantity(
    ...
    return ApiResponse.success(
        shoppingService.changeQuantity(principal.id(), cartItemId, request.quantity()));
  }
