...
import static com.delivery.cart.ControllerTestSupport.JSON;
import static com.delivery.cart.ControllerTestSupport.successfulDataId;
import static com.delivery.cart.ControllerTestSupport.successfulEnvelope;
import static com.delivery.cart.ControllerTestSupport.unauthenticated;
import static com.delivery.cart.ControllerTestSupport.userPrincipal;
import static com.delivery.cart.ControllerTestSupport.validationError;
import static com.delivery.cart.ControllerTestSupport.withApiErrors;
import static com.delivery.cart.TestFixtures.cart;
import static com.delivery.cart.TestFixtures.cartItem;
...
import com.delivery.cart.shopping.controller.ShoppingController;
...
class ShoppingControllerTests {
  ...
  void allCartEndpointsRejectMissingPrincipal() throws Exception {
    mvc.perform(
            post("/api/v1/cart-items").contentType(JSON).content("{\"skuId\":1001,\"quantity\":1}"))
