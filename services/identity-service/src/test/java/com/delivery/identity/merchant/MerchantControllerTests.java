...
import static com.delivery.identity.ControllerTestSupport.merchantPrincipal;
...
import static com.delivery.identity.TestFixtures.merchant;
import static com.delivery.identity.TestFixtures.merchantSession;
...
import com.delivery.identity.merchant.controller.MerchantController;
...
class MerchantControllerTests {
  ...
  void registerReturnsCreatedAndForwardsOptionalPasswordConfirmation() throws Exception {
    ...
    mvc.perform(
        ...
        .andExpect(successfulDataId(2));
    verify(service)
        .register(
            new MerchantService.RegisterRequest("shopper", "secret", null, "Store", "13900000000"));
  }
  ...
  @ValueSource(
      strings = {
        ...
        "{\"account\":\"shopper\",\"password\":\"secret\",\"name\":\""
            + " \",\"phone\":\"13900000000\"}",
  ...
  void protectedProfileEndpointsRejectMissingPrincipal() throws Exception {
    mvc.perform(get("/api/v1/merchants/me"))
