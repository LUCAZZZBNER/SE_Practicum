package com.delivery.identity.user.address.service;

import com.delivery.identity.common.DeleteResult;
import com.delivery.identity.common.PatchRequest;
...
public interface UserAddressService {
  ...
  record CreateRequest(
      ...
      @NotBlank @Pattern(regexp = "1[0-9]{10}") String phone,
  ...
  final class UpdateRequest extends PatchRequest {
    ...
    public boolean recipientSpecified() {
      return recipientSpecified;
    }

    public boolean phoneSpecified() {
