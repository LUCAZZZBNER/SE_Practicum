...
public class MerchantController {
  ...
  public ResponseEntity<ApiResponse<MerchantService.MerchantView>> register(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(ApiResponse.success(merchantService.register(request)));
  }

  @PostMapping("/login")
  @PublicEndpoint
  public ApiResponse<MerchantService.AuthSession> login(
      @Valid @RequestBody MerchantService.LoginRequest request) {
